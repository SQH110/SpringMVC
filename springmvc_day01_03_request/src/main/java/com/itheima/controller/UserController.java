...
public class UserController {
    ...
    public String requestParam1(String name,int age){//传入参数
    ...
    //使用对象属性名.属性名的对象层次结构可以为POJO中的POJO类型参数属性赋值（重点：层次结构一致）
    ...
    public String requestParam9(String[] nick){//形参为数组
